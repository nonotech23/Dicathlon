<section class="accueil">
    <nav>
        <a href="<?php echo(site_url()); ?>/Utilisateur">
        ...
        <ul id="primary">
            ...
            <li><a href="<?php echo(site_url()); ?>/Welcome/sports">Sports</a></li>
            <li><a href="<?php echo(site_url()); ?>/Welcome/réservations">Gérer les réservations</a></li>
        </ul>
